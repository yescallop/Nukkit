...
public class PlayerActionPacket extends DataPacket {
    ...
    public static final byte ACTION_DIMENSION_CHANGE_REQUEST = 13; //sent when dying in different dimension
    public static final byte ACTION_DIMENSION_CHANGE_ACK = 14; //sent when spawning in a different dimension to tell the server we spawned
    public static final byte ACTION_START_GLIDE = 15;
    public static final byte ACTION_STOP_GLINDE = 16;
    public static final byte ACTION_BUILD_DENIED = 17;
