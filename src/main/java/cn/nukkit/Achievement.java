...
public class Achievement {
    ...
    public static boolean broadcast(Player player, String achievementId) {
        ...
        String translation = Server.getInstance().getLanguage().translateString("chat.types.achievement", player.getDisplayName(), TextFormat.GREEN + achievements.get(achievementId).getMessage());
    ...
    public void broadcast(Player player) {
        String translation = Server.getInstance().getLanguage().translateString("chat.types.achievement", player.getDisplayName(), TextFormat.GREEN + this.getMessage(), null);
